...
- DHCP (Dynamic Host Configuration Protocol): Automatically assigns IP, subnet mask, gateway, and DNS servers via the DORA sequence (Discover $\rightarrow$ Offer $\rightarrow$ Request $\rightarrow$ Acknowledge).
