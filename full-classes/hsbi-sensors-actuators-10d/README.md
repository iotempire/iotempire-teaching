...
| [Module 9 — Capstone Project Studio](./modules/09-capstone-project-studio.md) | Project kickoff, requirement mapping, build, characterization, resilience, peer review |
...
- **Relationship to other modules:** This elective **builds on and extends** **[Networking and IoT Solutions](../hsbi-networking-iot-10d/README.md)** (4th semester): you already met the node, the local Wi-Fi network, the MQTT broker, Node-RED, and IoTempower there. As a 6th-semester elective, *Sensorik und Aktorik* is an **addition** that deepens the *physical* side — what a sensor really measures and how an actuator really moves. A shared capstone with the networking module is possible if the teaching team agrees on it in class, but it is **not the default**.
- **Hardware Kit:**
