...
**Placement:** This module fits after the gateway and MQTT infrastructure work and can span several weekly sessions.
...
> [!NOTE]
> This module already comes from the longer UT sequence, so its larger scope is intentional and suitable for a semester course.
